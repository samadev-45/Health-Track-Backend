...
namespace Health.Infrastructure.Migrations
{
    ...
    [Migration("20251122152411_AddAvailableDaysToDoctorProfile")]
    partial class AddAvailableDaysToDoctorProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Health.Domain.Entities.Consultation", b =>
                {
                    ...
                    b.Property<string>("HealthValues")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Health.Domain.Entities.MetricType", b =>
                {
                    b.Property<int>("MetricTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Health.Domain.Entities.HealthMetric", b =>
                {
                    b.HasOne("Health.Domain.Entities.MetricType", "MetricType")
